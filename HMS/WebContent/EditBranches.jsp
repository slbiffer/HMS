					...
					<div class="form-group row">
						...
						<div class="col-md-7">
							<input type="text" class="form-control" id="b_address"
								name="b_address" value="<%=b.getB_address()%>">
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<input type="text" class="form-control" id="b_telephone"
								name="b_telephone" value="<%=b.getB_telephone()%>">
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<input type="text" class="form-control" id="b_authorized_person"
								name="b_authorized_person"
								value="<%=b.getB_authorized_person()%>">
						</div>
					</div>
